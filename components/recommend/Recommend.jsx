      ...
      <>
          ...
          {dataHome.map((item) => {
            ...
            return (
                <SwiperSlide key={item?.id}>
                  ...
                  >
                    <div className="hotelsCard__image" style={{ height:200 }}>
        ...
        <div className="d-flex x-gap-15 items-center justify-center sm:justify-start pt-40 sm:pt-20">
          <div className="col-auto">
            <button className="d-flex items-center text-24 arrow-left-hover js-recommend-next"
          ...
          <div className="col-auto">
            <button className="d-flex items-center text-24 arrow-right-hover js-recommend-prev"
